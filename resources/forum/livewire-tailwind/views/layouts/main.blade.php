...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="forum bg-gradient-to-b from-blue-50 to-blue-100 dark:from-slate-800 dark:to-slate-900 text-gray-800 dark:text-gray-100">
        ...
        </div><div class="w-full flex justify-center mt-8">
            <form method="GET" action="{{ route('forum.search') }}" class="relative w-full max-w-xl">
                <!-- Input -->
                <input
                    type="text"
                    name="q"
                    placeholder="Tìm kiếm bài viết, chủ đề..."
                    class="w-full pl-12 pr-24 py-3 rounded-full bg-white dark:bg-slate-800 text-gray-900 dark:text-white border border-gray-300 dark:border-slate-600 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 placeholder-gray-400 dark:placeholder-slate-400"
                >
                ...
                <button
                    type="submit"
                    class="absolute right-1 top-1 bottom-1 px-5 rounded-full bg-blue-500 hover:bg-blue-600 text-white font-semibold text-sm shadow-md transition duration-150"
                >
                    Tìm
                </button>
            </form>
